...
// para validar el vacio poner la clase validate al div que contiene el input
// para validar un patron ponerle al input una de las clases de aqui abajo por ejemplo validate-pattern-email
...
// para validar que dos inputs sean iguales ponerle la clase validate-equal-email a los dos inputs que quiere que sean iguales ese email lo cambia por el nombre del atributo la clase se la pone al input


/*
ejemplo de los div que tiene que poner dentro del div ue contiene el input justo debajo del inpu
				<div class="error-message">
								Por favor confirme su Correo. para validar que no este vacio
							</div>
							<div class="pattern-error-message">
								Su correo debe tener el siguiente formato. para validar que cumpla con un formato
								email@example.com
							</div>
							<div class="match-error-message">
								Los correos no coinciden. parq validar que dos inputs sean iguales
							</div>	
*/
